...
public class JSONFormatter {
     ...
     * 
     * @param fieldNamingPolicy I don't know
     */
    public static final void setFieldNamingPolicy(
     ...
     * @return Object of the target type
     */
    public static <T> List<T> fromJSON(String responseString, Type type) {
        List<T> t = null;
        t = GSON.fromJson(responseString, (Type) type);
        return t;
    }
}
